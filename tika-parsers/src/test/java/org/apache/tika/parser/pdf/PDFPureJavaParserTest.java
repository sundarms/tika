 ...
 */
public class PDFPureJavaParserTest extends TikaTest {
    ...
    public static void setup() {
        //remember default logging level, but turn off for PDFPureJavaParserTest
...
//        assertEquals("Sat Sep 15 10:02:31 BST 2007", metadata.get(Metadata.LAST_MODIFIED));
    ...
    public void testProtectedPDF() throws Exception {
        ...
        try (InputStream stream = PDFPureJavaParserTest.class.getResourceAsStream(
...
/*    public void testAcroForm() throws Exception{
       ...
       PDFPureJavaParserConfigconfig = new PDFPureJavaParserConfig();
...
*/
    ...
    public void testSingleCloseDoc() throws Exception {
        ...
        try(InputStream is = PDFPureJavaParserTest.class.getResourceAsStream(
