...
public class TXTParserMetadataCharsetTest extends TikaTest {
    ...
    public void testCP866() throws Exception {
        ...
        StringWriter writer = new StringWriter();
        parser.parse(
                TXTParserMetadataCharsetTest.class.getResourceAsStream("/test-documents/russian.cp866.txt"),
                new WriteOutContentHandler(writer),
                metadata,
                new ParseContext());
    ...
    public void testEBCDIC_CP500() throws Exception {
        ...
        StringWriter writer = new StringWriter();
        parser.parse(
                TXTParserMetadataCharsetTest.class.getResourceAsStream("/test-documents/english.cp500.txt"),
                new WriteOutContentHandler(writer),
                metadata,
                new ParseContext());
