 ...
 * {@link PDFParserConfigNonOCR#setExtractInlineImages(boolean)}.
 */
public class PDFPureJavaParser extends AbstractParser {
    ...
    private PDFPureJavaParserConfig defaultConfig = new PDFPureJavaParserConfig();
    ...
    public PDFPureJavaParserConfig getPDFParserConfig() {
        return defaultConfig;
    }

    public void setPDFParserConfig(PDFPureJavaParserConfig config) {
     ...
     *
     * @deprecated use {@link #setPDFParserConfig(PDFParserConfigNonOCR)}
     */
